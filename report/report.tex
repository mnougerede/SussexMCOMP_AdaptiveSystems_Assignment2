...
\usepackage{caption}
\usepackage[section]{placeins}   % \FloatBarrier at each \section automatically
...
% Float placement: allow figures to occupy more of a page and appear sooner.
