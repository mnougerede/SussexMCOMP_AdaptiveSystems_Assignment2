...
but by handing the GA a better-developed phenotype to score. Read this way, the main methodological difference between this replication and
Williams's --- tournament selection replacing roulette-wheel selection --- is a
plausible explanation for why online HP was not significantly worse than no HP
here, where he reports it as worse. Tournament selection is less prone than
roulette-plus-elitism to amplifying small fitness differences into convergence on
a poor basin. This is offered as a possible explanation rather than a tested
claim, since the two GAs were not run side by side.
