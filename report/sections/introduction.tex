...
One might expect HP to improve the evolvability of the neural substrate as
well: networks that stay in their sensitive range should, in principle, present
smoother fitness gradients for evolution to follow. Williams tested this
expectation directly in his ball-catching experiments and found the relationship
more nuanced \parencite{williams2006}. HP applied as a developmental phase before
each fitness evaluation improved evolved performance, but HP running during
behaviour did not improve it, and in some conditions reduced it. The
substrate-level benefit did not translate straightforwardly into an evolutionary
one. Why a process that demonstrably helps the substrate should fail to help
when active during evaluation is the empirical puzzle this project sets out to
replicate and probe.
