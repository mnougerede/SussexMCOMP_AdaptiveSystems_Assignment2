...
fitness is the mean per-shape score over the $20$ shapes in the trial, and an
individual's fitness is the mean over $10$ independently-seeded trials to
average out the randomised shape sequences.
...
Tournament selection is the standard choice in evolutionary computation and is
less prone to the early fitness-variance collapse that roulette-wheel selection
can cause; the consequences for comparison with Williams are discussed in
